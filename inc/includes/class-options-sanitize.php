...
function of_recognized_background_repeat() {
	...
	$default = array(
		'no-repeat' => __( 'No Repeat', 'i-am-one' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'i-am-one' ),
		'repeat-y'  => __( 'Repeat Vertically', 'i-am-one' ),
		'repeat'    => __( 'Repeat All', 'i-am-one' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'i-am-one' ),
		'top center'    => __( 'Top Center', 'i-am-one' ),
		'top right'     => __( 'Top Right', 'i-am-one' ),
		'center left'   => __( 'Middle Left', 'i-am-one' ),
		'center center' => __( 'Middle Center', 'i-am-one' ),
		'center right'  => __( 'Middle Right', 'i-am-one' ),
		'bottom left'   => __( 'Bottom Left', 'i-am-one' ),
		'bottom center' => __( 'Bottom Center', 'i-am-one' ),
		'bottom right'  => __( 'Bottom Right', 'i-am-one')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'i-am-one' ),
		'fixed'  => __( 'Fixed in Place', 'i-am-one')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'i-am-one' ),
		'italic'      => __( 'Italic', 'i-am-one' ),
		'bold'        => __( 'Bold', 'i-am-one' ),
		'bold italic' => __( 'Bold Italic', 'i-am-one' )
		);
